...
*   **📜 Playlist Management**: Create custom playlists with personalized names and creator info. Add songs to playlists with integrated search, shuffle play entire playlists, remove individual songs or clear all songs at once. View playlist details with song count, creation date, and dynamic cover art.
